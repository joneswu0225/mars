...
ssh ubuntu@123.207.49.36 "cd projects/mars; rm mars.jar.bak; mv mars.jar mars.jar.bak;"
scp target/mars-0.0.1-SNAPSHOT.jar ubuntu@123.207.49.36:/home/ubuntu/projects/mars/mars.jar
