...
//        param.setOperatorId(LoginUtil.getInstance().getUser().getId());
    ...
    public BaseResponse findOne(@PathVariable String departmentId) {
...
//        param.setOperatorId(LoginUtil.getInstance().getUser().getId());
    ...
    public BaseResponse delete(@PathVariable @ApiParam(required=true) String departmentId) {
    ...
    public BaseResponse removeUser(@PathVariable @ApiParam(required=true) String departmentId,
