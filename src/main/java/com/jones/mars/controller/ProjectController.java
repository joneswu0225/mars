...
public class ProjectController extends BaseController {
    ...
    public BaseResponse delete(@PathVariable @ApiParam(required=true) Long projectId) {
        return projectService.delete(projectId);
    }

    @ApiOperation(value = "获取项目共建人", notes = "")
    @GetMapping("{projectId}/user")
    public BaseResponse findProjectPartner(@PathVariable @ApiParam(required=true) Long projectId,
    ...
    public BaseResponse findProjectPartnerAvailablePage(@PathVariable @ApiParam(required=true) Long projectId,
    ...
    public BaseResponse findProjectPartnerAvailableAll(@PathVariable @ApiParam(required=true) Long projectId,
                                                       @ApiParam(required=true) RolePermissionQuery query) {
        query.setProjectId(projectId);
    ...
    public BaseResponse findProjectPartnerAll(@PathVariable @ApiParam(required=true) Long projectId,
                                           @ApiParam(required=true) ProjectUserQuery query) {
        query.setProjectId(projectId);
    ...
    public BaseResponse addPartner(@PathVariable @ApiParam(required=true) Long projectId,
    ...
    public BaseResponse updateProjectManager(@PathVariable @ApiParam(required=true) Long projectId,
    ...
    public BaseResponse deletePartner(@PathVariable @ApiParam(required=true) Long projectId,
                                      @PathVariable @ApiParam(required=true) Long userId) {
    ...
    public BaseResponse publishProject(@PathVariable @ApiParam(required=true) Long projectId,
    ...
    public BaseResponse submitVerifyProject(@PathVariable @ApiParam(required=true) Long projectId) {
        return  projectService.submitVerifyProject(projectId);
    }

    @ApiOperation(value = "下架的项目退回编辑", notes = "")
    @PatchMapping("{projectId}/remodify")
    public BaseResponse remodifyProject(@PathVariable @ApiParam(required=true) Long projectId,
    ...
    public BaseResponse verifyProject(@PathVariable @ApiParam(required=true) Long projectId,
    ...
    public BaseResponse offshelfProject(@PathVariable @ApiParam(required=true) Long projectId) {
        return  projectService.offshelfProject(projectId);
    }

    @ApiOperation(value = "公开项目", notes = "")
    @PatchMapping("{projectId}/public")
    public BaseResponse publicProject(@PathVariable @ApiParam(required=true) Long projectId) {
        return  projectService.publicProject(projectId);
    }

    @ApiOperation(value = "取消公开项目", notes = "")
    @PatchMapping("{projectId}/unpublic")
    public BaseResponse unpublicProject(@PathVariable @ApiParam(required=true) Long projectId) {
