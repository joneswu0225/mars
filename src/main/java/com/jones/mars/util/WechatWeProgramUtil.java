...
public class WechatWeProgramUtil {
    ...
    private static Map<String, WeprogramInfo> weprogramInfoMap;
     ...
     * @param code
     */
    public static JSONObject getSessionKey(String weprogramId, String code) {
        try {
     ...
     * @return
     */
    public static Map<String, String> getUserInfo(String weprogramId, String code, String encrypedData, String iv) {
