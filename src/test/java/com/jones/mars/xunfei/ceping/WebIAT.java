package com.jones.mars.xunfei.ceping; /**
 * 语音听写 WebAPI 接口调用示例
 * 运行方法：直接运行 main() 即可
 * 结果： 控制台输出语音听写结果信息
 * @author iflytek
...
public class WebIAT {
	...
	private static final String APPID = "5ced5c75";
	// 接口密钥（webapi类型应用开通听写服务后，控制台--我的应用---语音听写---相应服务的apikey）
	private static final String API_KEY = "d681acc63c434f897fec53d37f3bbffb";
	// 音频编码
	...
	private static final String AUDIO_PATH = "./src/test/java/com/jones/mars/xunfei/ceping/iat_wav_16k.wav";
//	private static final String AUDIO_PATH = "./src/test/java/com/jones/mars/xunfei/ceping/en_sentence.wav";
